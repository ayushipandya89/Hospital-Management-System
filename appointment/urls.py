...
from .views import ViewAppointments, ViewRooms, ViewAdmitPatient, \
    ViewNotDischarged, SearchRoom, SearchAdmit, LoadTimeslots, ViewDischargePatient
...
urlpatterns = [
    ...
    path('view_not_dicharge/', ViewNotDischarged.as_view(), name='view-discharge-patient'),
